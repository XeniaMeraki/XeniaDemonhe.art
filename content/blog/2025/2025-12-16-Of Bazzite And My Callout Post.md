...
What is Bazzite? A [linux-based gaming-focused operating system.](https://bazzite.gg/)

Code of Conduct? Rules that basically say "Be nice"

Who? [Antheas](https://github.com/antheas). The developer of Handheld Daemon, primary dev of The Bazzite Kernel, dev of HHD Rechunker. Basically a good large chunk of what makes Bazzite work on PCs and handheld PCs, especially important for getting the inputs side of various handheld PCs like the ROG Ally, SteamDeck, and Legion Go working with videogames on Bazzite.

Antheas_ has been a thorn in the side of Bazzite and FOSS spaces in general for months. He's an extremely talented and knowledgable developer, hugely important to Bazzite as a project. But he's an asshole. Not even just a little bit, but a lot, repeatedly, over, and over, and over, again, and again, and again. He's made devs leave projects and cut ties with Bazzite as a project, he's been a nuisance in handheld PC space, and he's just plain mean to fellow developers and peers. He has never once been cruel to me directly, but I was never the less not happy seeing his behavior, and *pissed* when seeing him insult my friends.
...
<mark>Antheas</mark>: "If you don't like my python implementation, you can reimplement hhd in rust and once the implementation is ready you can even use my name, domain, and github repos as well"
"I'm quite fond of the name, it's easy to type as a command and memorable"

<mark>Antheas</mark>: "I would prefer you focusing on ogui"
"I don't want you to "stop what you're doing" on anything except inputplumber"
...
Antheas has some real god power complex going on. Egomania. Sociopathy. *Something*. I don't know and I don't care what exactly it is. I like Bazzite and Bazaar and Bluefin as projects. Having him around in these dev and community spaces *bothered me* being the way he is. Antheas had wedged himself into that position of power one can wield in a company or organization when they are "too important" to let go because of some service they do for the organization. And they can then be cruel to coworkers, users, peers because of the value they bring to the organization. This is sadly a common archetype of person. The asshole that controls the Minecraft server of a friend group. The asshole that controls the backend library of a million dollar company. The asshole at the DND session that has a 3D printer. Taking advantage of their usefulness to others to be cruel for lack of consequences able or willing to be leveraged upon them. It's a dirty social engineering trick to take advantage of.

Try and not have this situation occur by you, and occur in your communities. Spread out power and responsibilities, be mindful of dev composure even towards other developers. Above all, having empathy, attempting to understand and level with people will prevent you turning into this. I know most of the lot of the Bazzite devs are decent, hard working people. Very kind, very progressive, and I appreciate that. Again, I respect the hell out of Bazzite and [Aurora](https://getaurora.dev/en) and [Bluefin](https://projectbluefin.io/) as projects. I realize that things can get heated in this space, as we are developing software for users, making decisions and organizing The Future, enacting our politics and values as we see fit in our conversations and spaces. It doesn't have to be personal, it doesn't have to be cruel. I know this was a unique situation that slowly cropped up. It should still have been dealt with months ago. And ideally I wouldn't have needed to draft up a fucking, callout post.
...
I'd rather not have gone after this man's casual hobby to be quite honest. It's not really my Thing to be a drama hound and get people ejected or fired from places. Bazzite will suffer on a technical level now. [Bazzite is always open to new devs and contributors just sayin](https://github.com/ublue-os/bazzite/) I am happy that these spaces can heal now but it's bittersweet. I would rather Antheas have just learned and listened and apologized and done better. I've done and said things I regret and I either apologized for or wish I apologized for. I believe in most people's capacity to be kind and open to learning.
